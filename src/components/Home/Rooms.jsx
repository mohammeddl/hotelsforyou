...
export default function Rooms() {
  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto px-4 py-12">
      ...
      <div className="rounded-lg overflow-hidden shadow-lg">
        ...
        <div className="p-4 bg-white dark:bg-gray-950">
          ...
          <p className="text-gray-500 dark:text-gray-400 mb-4">Luxurious penthouse suite with panoramic city views.</p>
          <div className="flex items-center justify-between">
